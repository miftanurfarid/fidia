function [output_correlogram,outgamma,outhc] = mcorrelogram(lowfreq, highfreq, filterdensity, mindelay, maxdelay, transduction, binauralswitch, wave, infoflag)
