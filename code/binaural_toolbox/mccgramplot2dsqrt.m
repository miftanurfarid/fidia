function cda = mccgramplot2dsqrt(correlogram, optional_markersize, optional_linewidth)
% function null = 
...
%% calculate average cross-correlogram
...
[val, loc] = max(integratedccfunction);
cda = correlogram.delayaxis(loc);
