function cda = mccgramplot4panel(correlogram, optional_markersize, optional_linewidth)
...
if (correlogram.nfilters > 1)
   ...
   fprintf('plotting 3-dimensional correlogram using mccgramplot3dmesh \n');
   subplot(2,2,1);
   ...
   fprintf('plotting 3-dimensional correlogram using mccgramplot3dsurf \n');
   subplot(2,2,2);
   ...
   fprintf('plotting 2-dimensional correlogram using mccgramplot2dsqrt \n');
   if nargin == 1 
   ...
   fprintf('plotting across-freq average using mccgramplotaverage \n');
   cda = mccgramplotaverage(correlogram);
